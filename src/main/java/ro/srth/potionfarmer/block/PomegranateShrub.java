...
public class PomegranateShrub extends SweetBerryBushBlock {
    public static final IntegerProperty AGE = IntegerProperty.create("age", 0, 3);
    public static final int MAX_AGE = 7;

    public PomegranateShrub(Properties pProperties) {
        super(pProperties);
    ...
    public ItemStack getCloneItemStack(BlockGetter pLevel, BlockPos pPos, BlockState pState) {
        return new ItemStack(ItemRegistry.POMEGRANATE.get());
    }
    ...
    public InteractionResult use(BlockState pState, Level pLevel, BlockPos pPos, Player pPlayer, InteractionHand pHand, BlockHitResult pHit) {
        ...
        if (!flag && pPlayer.getItemInHand(pHand).is(Items.BONE_MEAL)) {
            ...
            popResource(pLevel, pPos, new ItemStack(ItemRegistry.POMEGRANATE.get(), j + (flag ? 1 : 0)));
